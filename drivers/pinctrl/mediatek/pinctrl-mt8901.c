...
static const char * const mt8901_eint_register_base_name[] = {
	"eintl", "eintb", "eintr", "eintc",
};
...
static const struct mtk_eint_hw mt8901_eint_hw = {
	...
	.base_names = mt8901_eint_register_base_name,
	.nbase_names = ARRAY_SIZE(mt8901_eint_register_base_name),
};
...
MODULE_DEVICE_TABLE(of, mt8901_pinctrl_of_match);
